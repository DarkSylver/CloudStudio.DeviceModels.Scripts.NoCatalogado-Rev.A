...
//Generic sensors_modelo
function getEndpoints(deviceAddress, endpoints)

{

  var data1 = endpoints.addEndpoint("1", "test 1", endpointType.genericSensor);

        data1.variableTypeId = 1125;

 

  var data2 = endpoints.addEndpoint("2", "test 2", endpointType.genericSensor);

        data2.variableTypeId = 1124;
