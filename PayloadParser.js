...
{
    var dispositivoRARO_EMIC = payload.asJsonObject()   

    env.log(dispositivoRARO_EMIC); 

    var sensor1 = device.endpoints.byAddress(1);

    if (sensor1 != null){

        sensor1.updateGenericSensorStatus(dispositivoRARO_EMIC.dato1);
    }
    ...
    if (sensor2 != null){
        ...
        sensor2.updateGenericSensorStatus(dispositivoRARO_EMIC.dato2);
    }
}
