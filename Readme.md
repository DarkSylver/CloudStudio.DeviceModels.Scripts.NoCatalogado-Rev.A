...
# Parsing + Configuration Script – No Catalogado - Rev. A

This **Parsing + Configuration** script is designed for the **No Catalogado** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – No Catalogado Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **No Catalogado** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
